...
public class CodigoDeBarras extends BlockOfFields {
	...
	private void calculateAndSetDigitoVerificadorGeral() {
		...
		StringBuilder toCalculateDV = new StringBuilder(codigoDoBanco.write()).append(codigoDaMoeda.write()).append(fatorDeVencimento.write()).append(valorNominalDoTitulo.write()).append(campoLivre.write());

		// Realizando o cálculo dígito verificador e em seguida armazenando
		// a informação no campo "digitoVerificadorGeral".
		digitoVerificadorGeral.setValue(calculadorDV.calcule(toCalculateDV.toString()));

		if (log.isDebugEnabled())
			log.debug("Digito Verificador Geral calculado : " + digitoVerificadorGeral.getValue());
	}
	...
	private void calculateAndSetFatorDeVencimento(Date vencimento) {
		...
		fatorDeVencimento.setValue(FatorDeVencimento.toFator(vencimento));
	}
	...
	/**
	 * @param digitoVerificadorGeral
	 *            the digitoVerificadorGeral to set
	 */
	...
	/**
	 * @param valorNominalDoTitulo
	 *            the valorNominalDoTitulo to set
	 */
