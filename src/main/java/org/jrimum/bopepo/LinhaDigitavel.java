...
public class LinhaDigitavel extends BlockOfFields {
	...
	public String write() {
		...
		return new StringBuilder(innerCampo1.write()).append(Strings.WHITE_SPACE).append(innerCampo2.write()).append(Strings.WHITE_SPACE).append(innerCampo3.write()).append(Strings.WHITE_SPACE).append(campo4.write())
				.append(Strings.WHITE_SPACE).append(innerCampo5.write()).toString();
