...
public final class CampoLivreFactory {
	...
	public static CampoLivre create(String strCampoLivre) {
		...
		Objects.checkArgument(!StringUtils.containsAny(strCampoLivre, " "), "O Campo Livre [ " + strCampoLivre + " ] não deve conter espaços em branco!");
		Objects.checkArgument(StringUtils.isNumeric(strCampoLivre), "O Campo Livre [ " + strCampoLivre + " ] deve ser uma String numérica!");
	...
	private static CampoLivre valueOf(String strCampoLivre) {
		CampoLivre campoLivre = new CampoLivre() {
			...
			FixedField<String> campo = new FixedField<String>(StringUtils.EMPTY, STRING_LENGTH, Fillers.ZERO_LEFT);
