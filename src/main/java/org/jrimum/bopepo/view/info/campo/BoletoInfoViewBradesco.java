...
public class BoletoInfoViewBradesco extends AbstractBoletoInfoCampoView {
	...
	public String getTextoFcAgenciaCodigoCedente() {
		...
		return StringUtils.leftPad(agencia.getCodigo().toString(), 4, "0") + "-" + agencia.getDigitoVerificador() + " / " + StringUtils.leftPad(numeroDaConta.getCodigoDaConta().toString(), 7, "0") + "-"
	...
	public String getTextoFcNossoNumero() {
		...
		return StringUtils.leftPad(carteira.getCodigo().toString(), 2, "0") + "/" + getBoleto().getTitulo().getNossoNumero() + "-" + getBoleto().getTitulo().getDigitoDoNossoNumero();
	}
