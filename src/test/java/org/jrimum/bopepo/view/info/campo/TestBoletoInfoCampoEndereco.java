...
public class TestBoletoInfoCampoEndereco {
	...
	public void deve_retornar_linha1_vazia_para_entidade_de_cobraca_null() {
		...
		assertThat(BoletoInfoCampoEndereco.getTextoEnderecoLinha1(entidade), equalTo(StringUtils.EMPTY));
	}
	...
	public void deve_retornar_linha1_para_endereco_quando_bairro_blank() {
		...
		endereco.setBairro(StringUtils.EMPTY);
	...
	public void deve_retornar_linha1_vazia_para_endereco_null() {
		...
		assertThat(BoletoInfoCampoEndereco.getTextoEnderecoLinha1(endereco), equalTo(StringUtils.EMPTY));
	}
	...
	public void deve_retornar_linha2_vazia_para_entidade_de_cobraca_null() {
		...
		assertThat(BoletoInfoCampoEndereco.getTextoEnderecoLinha2(entidade), equalTo(StringUtils.EMPTY));
	}
	...
	public void deve_retornar_linha2_vazia_para_endereco_null() {
		...
		assertThat(BoletoInfoCampoEndereco.getTextoEnderecoLinha2(endereco), equalTo(StringUtils.EMPTY));
	}
