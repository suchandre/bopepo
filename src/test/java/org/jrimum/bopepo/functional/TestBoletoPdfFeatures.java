...
public class TestBoletoPdfFeatures {
	...
	public void deve_ter_todos_os_meta_dados_do_boleto_em_pdf_definidos_pelo_usuario() {
		byte[] boletoPdf = BoletoViewer.create(BoletoBuilder.defaultValue()).setPdfTitulo("Titulo").setPdfAssunto("Assunto").setPdfPalavrasChave("Palavras Chave").setPdfAutor("Autor").getPdfAsByteArray();
